    ...
    <PageLayout
      ...
      actions={
        !isDeletedView && isSudoAdmin ? (
          <button type="button" onClick={() => navigate("/dashboard/marketing/email-recipients/deleted")} className="flex h-[34px] items-center gap-[8px] rounded-full border border-[#d2d2d7] bg-white px-[21px] text-[13px] font-medium text-[#1d1d1f] transition-colors hover:bg-[#f5f5f7]">
      ...
      <AlertDialog open={confirm.open} onOpenChange={(o) => !o && confirm.dismiss()}>
        <AlertDialogContent className="bg-white">
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              {confirm.action === "recover" ? "This will restore the recipient." : confirm.action === "destroy" ? "This cannot be undone." : "This will move the recipient to trash."}
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
