...
const inputCls =
  "h-11 w-full rounded-xl border border-[#d2d2d7] bg-white px-4 pr-11 text-[14px] text-[#1d1d1f] placeholder-[#86868b] outline-none transition focus:border-[var(--primary)] focus:ring-2 focus:ring-[var(--primary)]/10";
