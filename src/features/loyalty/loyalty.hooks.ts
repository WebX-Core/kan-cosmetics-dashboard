...
export const useLoyaltyCustomer = (customerId?: string) => useQuery({ queryKey: ["loyalty", "customer", customerId], queryFn: () => loyaltyApi.customers.get(customerId!), enabled: Boolean(customerId) });
