...
export const statCardColors = {
  blue:    { bg: "bg-blue-500/10", iconBg: "bg-blue-500/10", iconColor: "text-blue-500",  textColor: "text-[#1d1d1f]"  },
  ...
  purple:  { bg: "bg-blue-500/10", iconBg: "bg-blue-500/10", iconColor: "text-blue-500",  textColor: "text-[#1d1d1f]"  },
  violet:  { bg: "bg-blue-500/10", iconBg: "bg-blue-500/10", iconColor: "text-blue-500",  textColor: "text-[#1d1d1f]"  },
...
export const buttonStyles = {
  primary:   "flex h-[34px] items-center rounded-full bg-blue-500 px-[21px] text-[13px] font-medium text-white transition-colors hover:bg-blue-600",
  ...
  dark:      "flex h-[34px] items-center rounded-full bg-[#1d1d1f] px-[21px] text-[13px] font-medium text-white transition-colors hover:bg-blue-500",
