// Apple-inspired Design System — Golden Ratio spacing, clean white, #0071e3 accent

export const statCardColors = {
  blue:    { bg: "bg-[#0071e3]/10", iconBg: "bg-[#0071e3]/10", iconColor: "text-[#0071e3]",  textColor: "text-[#1d1d1f]"  },
  ...
  purple:  { bg: "bg-[#0071e3]/10", iconBg: "bg-[#0071e3]/10", iconColor: "text-[#0071e3]",  textColor: "text-[#1d1d1f]"  },
  violet:  { bg: "bg-[#0071e3]/10", iconBg: "bg-[#0071e3]/10", iconColor: "text-[#0071e3]",  textColor: "text-[#1d1d1f]"  },
...
export const statusColors = {
  proposal:    "bg-[#0071e3]/10 text-[#0071e3] border-[#0071e3]/20",
  qualified:   "bg-[#0071e3]/10 text-[#0071e3] border-[#0071e3]/20",
...
export const tableStyles = {
  ...
  tabActive:       "bg-[#0071e3] text-white",
...
export const buttonStyles = {
  primary:   "flex h-[34px] items-center rounded-full bg-[#0071e3] px-[21px] text-[13px] font-medium text-white transition-colors hover:bg-[#0066cc]",
  ...
  dark:      "flex h-[34px] items-center rounded-full bg-[#1d1d1f] px-[21px] text-[13px] font-medium text-white transition-colors hover:bg-[#0071e3]",
